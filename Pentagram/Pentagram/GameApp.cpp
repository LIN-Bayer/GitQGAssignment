...
bool GameApp::InitResource()
{
	...
	{
		{ XMFLOAT3(0.0f, 0.0f, 5.0f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(2.2*0.5f, 0.0f, 3.1 * 0.5f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(9.5 * 0.5f, 0.0f, 3.1 * 0.5f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(3.6 * 0.5f, 0.0f, -1.2 * 0.5f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(5.8 * 0.5f, 0.0f, -8.1 * 0.5f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
		{ XMFLOAT3(0.0f, 0.0f, -3.8 * 0.5f), XMFLOAT4(1.0f, 0.0f, 1.0f, 1.0f) },
		{ XMFLOAT3(-5.8 * 0.5f, 0.0f, -8.1 * 0.5f), XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f) },
		{ XMFLOAT3(-3.6 * 0.5f, 0.0f, -1.2 * 0.5f), XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
		{ XMFLOAT3(-9.5 * 0.5f, 0.0f, 3.1 * 0.5f), XMFLOAT4(1.0f, 0.0f, 1.0f, 1.0f) },
		{ XMFLOAT3(-2.2 * 0.5f, 0.0f, 3.1 * 0.5f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(0.0f, 3.0f, 0.0f), XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f) },
	};
	// 设置顶点缓冲区描述
